...
public class Search {
    ...
    public static int[] ratFinder(char[][] maze) throws EscapedRatException, CrowdedMazeException {
        ...
        if(ratCount == 0)throw new CrowdedMazeException();
        if (ratCount > 0) throw new CrowdedMazeException();
